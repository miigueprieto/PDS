...
def filtro_semitono(imagen, tamano_bloque):
...
imagen_original = skimage.data.chelsea()
imagen_filtrada = filtro_semitono(imagen_original, 8)
...
axes[1].set_title("Efecto Semitono")
axes[1].axis("off")
